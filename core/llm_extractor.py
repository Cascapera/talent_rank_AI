...
def _build_system_prompt(job_description: str, weights: dict[str, int], role_titles: list[str], is_batch: bool = False) -> str:
    ...
    if is_batch:
        return (
            ...
            "Calcule a aderência de 0 a 100% seguindo os pesos abaixo. Considere apenas as ÚLTIMAS 3 experiências profissionais do candidato:\n"
            f"{weights_json}\n\n"
            "Regras:\n"
            ...
            "- Para definir a senioridade, considere somente tempo e cargos em Tecnologia/Desenvolvimento (ex.: Software Engineer, Dev, Data, QA, DevOps, Infra, Segurança etc.).\n"
            "- Desconsidere experiências fora desse ramo (comercial, administrativo, marketing etc.).\n"
