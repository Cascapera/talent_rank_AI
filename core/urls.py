...
urlpatterns = [
    ...
    path(
        "vagas/<int:job_id>/preview-search/",
        views.preview_candidates_search,
        name="preview_candidates_search",
    ),
    path(
        "vagas/<int:job_id>/search-pool/",
        views.search_candidates_in_pool,
        name="search_candidates_in_pool",
    ),
    path(
        "vagas/<int:job_id>/candidatos/<int:candidate_job_id>/status/",
